...
castle_grammar = r"""
start: program
?program: "crown" "TILDE" global_dec user_defined_func "castle" "treasures" IDENTIFIER "LPAREN" "RPAREN" "LCUR" body "return" "0" "TILDE" "RCUR" "reign" "TILDE" "EOF"
...
user_defined_func: "spell" return_type IDENTIFIER "LPAREN" param "RPAREN" "LCUR" body ret_statement "RCUR" user_defined_func
                 | 
