...
from RS_RegDef import all_delims
        ...
        while self.position < len(self.code):
            ...
            if char == 'b':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['witch_delim'] or self.current_char() not in Delims['gate_delim']:
                        self.advance()
                    continue
            ...
            if char == 'c':
                ...
                if valid:
                    ...
                    while self.current_char() != ' ' or self.current_char() not in Delims['witch_delim'] or self.current_char() not in Delims['gate_delim'] or self.current_char() not in Delims['genie_delim']:
                        self.advance()
                    continue
            ...
            if char == '>':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['relational_operator_delim']:
                        self.advance()
                    continue
            ...
            if char == '(':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['open_parentheses_delim']:
                        self.advance()
                    continue
            ...
            if char == ')':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['close_parentheses_delim']:
                        self.advance()
                    continue
            ...
            if char == '{':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['open_curly_bracket_delim']:
                        self.advance()
                    continue
            ...
            if char == '}':
                ...
                if valid:
                    ...
                    while self.current_char() not in RegDef['whitespace'] or self.current_char() not in RegDef['alpha_small']:
                        self.advance()
                    continue
            ...
            if char == '[':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['open_square_bracket_delim']:
                        self.advance()
                    continue
            ...
            if char == ']':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['close_square_bracket_delim']:
                        self.advance()
                    continue
            ...
            if char == '~':
                ...
                if valid:
                    ...
                    while self.current_char() != '?' or self.current_char() != '}' or self.current_char() not in RegDef['whitespace'] or self.current_char() not in RegDef['alpha_small']:
                        self.advance()
                    continue
            ...
            if char == ',':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['comma_delim']:
                        self.advance()
                    continue
            ...
            if char in RegDef['alpha_big']:
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['id_delim']:
                        self.advance()
                    continue
            ...
            if char == '"':
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['book_delim']:
                        self.advance()
                    continue
            ...
            if char in RegDef ['number']:
                ...
                if valid:
                    ...
                    while self.current_char() not in Delims['number_delim']:
                        self.advance()
                    continue
