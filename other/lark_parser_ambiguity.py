class RoyalScriptParser: 
    ...
    # <expression_ext_1>
    ('<expression_ext_1>', '>'): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>'],
    ('<expression_ext_1>', '=='): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>'],
    ('<expression_ext_1>', '!='): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>'],
    ('<expression_ext_1>', '>='): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>'],
    ('<expression_ext_1>', '<='): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>'],
    ...
    ('<expression_ext_1>', '||'): ['<logical_operator>', '<logical_operator1>', '<logical_operand>', '<more_log>', ')'],
    ('<expression_ext_1>', '-'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<relational_operator>', '<relational_operand>', '<relational_more>'],
    ('<expression_ext_1>', '/'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<relational_operator>', '<relational_operand>', '<relational_more>'],
    ('<expression_ext_1>', '%'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<relational_operator>', '<relational_operand>', '<relational_more>'],
    ('<expression_ext_1>', '+'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<relational_operator>', '<relational_operand>', '<relational_more>'],
    ('<expression_ext_1>', '*'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<relational_operator>', '<relational_operand>', '<relational_more>'],
    ...
    ('<granted_open_paren_ext>', '('): ['(', '<granted_open_paren_ext>'],

    # <idlit3_granted_ext>
    ('<idlit3_granted_ext>', '>'): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>', '<more_log>'],
    ('<idlit3_granted_ext>', '=='): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>', '<more_log>'],
    ('<idlit3_granted_ext>', '!='): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>', '<more_log>'],
    ('<idlit3_granted_ext>', '>='): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>', '<more_log>'],
    ('<idlit3_granted_ext>', '<='): ['<relational_operator>', '<relational_operand>', '<relational_more>', ')', '<relational_more>', '<more_log>'],
    ...
    ('<idlit3_granted_ext>', '||'): ['<logical_operator>', '<logical_operator1>', '<logical_operand>', '<more_log>', ')', '<more_log>'],
    ('<idlit3_granted_ext>', '-'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<open_paren_other_ext>'],
    ('<idlit3_granted_ext>', '/'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<open_paren_other_ext>'],
    ('<idlit3_granted_ext>', '%'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<open_paren_other_ext>'],
    ('<idlit3_granted_ext>', '+'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<open_paren_other_ext>'],
    ('<idlit3_granted_ext>', '*'): ['<arithmetic_operator>', '<arithmetic_operand>', '<more_arith>', ')', '<more_arith>', '<open_paren_other_ext>'],
    ...
    ('<open_paren_other_ext>', '<='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<more_log>'],
    ('<open_paren_other_ext>', '<'): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<more_log>'],
    ('<open_paren_other_ext>', '&&'): ['<logical_operator>', '<more_log>'],
    ('<open_paren_other_ext>', '||'): ['<logical_operator>', '<more_log>'],
    ...
    ('<close_paren_ext>', '<='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<more_log>'],
    ('<close_paren_ext>', '<'): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<more_log>'],
    ('<close_paren_ext>', '&&'): ['<logical_operator>', '<more_log>'],
    ('<close_paren_ext>', '||'): ['<logical_operator>', '<more_log>'],
    ...
    ('<granted_other_id_ext>', '/'): ['/', '<arithmetic_operand>', '<more_arith>', '<granted_other_id_ext2>'],
    ('<granted_other_id_ext>', '%'): ['%', '<arithmetic_operand>', '<more_arith>', '<granted_other_id_ext2>'],
    ('<granted_other_id_ext>', '>'): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<granted_other_id_ext>', '>='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<granted_other_id_ext>', '<'): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<granted_other_id_ext>', '<='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<granted_other_id_ext>', '=='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ...
    # <granted_other_id_ext2>
    ('<granted_other_id_ext2>', '>'): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<granted_other_id_ext2>', '>='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<granted_other_id_ext2>', '<'): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<granted_other_id_ext2>', '<='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<granted_other_id_ext2>', '=='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ...
    # <plus_ext>
    ('<plus_ext>', 'identifier'): ['identifier', '<plus_ext_1>'],
    ...
    ('<val1_ext>', '/'): ['/', '<arithmetic_operand>', '<more_arith>', '<granted_other_id_ext2>'],
    ('<val1_ext>', '%'): ['%', '<arithmetic_operand>', '<more_arith>', '<granted_other_id_ext2>'],
    ('<val1_ext>', '>'): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<val1_ext>', '>='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<val1_ext>', '<'): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<val1_ext>', '<='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
    ('<val1_ext>', '=='): ['<relational_operator>', '<relational_operand>', '<relational_more>', '<granted_other_id_ext1>'],
